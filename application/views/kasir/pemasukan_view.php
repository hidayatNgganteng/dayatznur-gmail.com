...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="h3 ml-auto">Semua data pemasukan</div>
        ...
        <div class="container-fluid">
          ...
          <?php
            if($this->session->userdata('level')==1) {
              echo '<button class="btn btn-success" onclick="tambah_pemasukan()"><i class="glyphicon glyphicon-plus"></i> tambah</button><br><br>';
            } ?>
  ...
  <script>
      ...
      function save(){
          const url = "<?php echo site_url('option/simpan_pemasukan')?>";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Input pemasukan</h5>
